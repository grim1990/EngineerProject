...
public class LoginWith2faModel : PageModel
{
    ...
    public class InputModel
    {
        ...
        /// </summary>
        [Required]
        [StringLength(7, ErrorMessage = "{0} musi zawierać minimum {2} a maksimum {1} znakwó.", MinimumLength = 6)]
    ...
    public async Task<IActionResult> OnGetAsync(bool rememberMe, string returnUrl = null)
    {
        ...
        if (user == null)
        {
            throw new InvalidOperationException($"Nie można załadować autentykacji dwuetapowej użytkownika.");
        }
